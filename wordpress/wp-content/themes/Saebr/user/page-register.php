...
?>
	<div id="primary" class="content-area">
		...
		<?php if(!is_user_logged_in()){ ?>
			<div class="ex-register">
				...
				<form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="post">  
					<p><input type="text" name="user_login" tabindex="1" id="user_login" class="input" value="<?php if(!empty($sanitized_user_login)) echo $sanitized_user_login; ?>" placeholder="昵称（例：本间芽衣子）" required /></p>
					<p><input type="text" name="user_email" tabindex="2" id="user_email" class="input" value="<?php if(!empty($user_email)) echo $user_email; ?>" size="25" placeholder="电子邮箱（例：1986@163.com）" required /></p>
					<p><input id="user_pwd1" class="input" tabindex="3" type="password" tabindex="21" size="25" value="" name="user_pass" placeholder="密码（6-16个字符组成，区分大小写" required /></p>
		...
		<?php } ?>
		<?php else : ?>
			<div class="register-close"><p>哎呀，网站管理员尚未开放注册功能。请联系站长解决啦！</p></div>
		<?php endif; ?>
		</main><!-- #main -->
	</div><!-- #primary -->
<style type="text/css">
