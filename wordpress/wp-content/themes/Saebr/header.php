...
<script src="<?php bloginfo('template_url'); ?>/js/sweetalert.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/inc/sweetalert.min.css" type="text/css" media="all" />
<script src="<?php bloginfo('template_url'); ?>/inc/js/dingstudio.app.js" type="text/javascript"></script>
...
if (!!window.ActiveXObject || "ActiveXObject" in window) { //is IE?
  alert('小丁工作室温馨提示：请抛弃万恶的IE系列浏览器吧。');
}
</script>
</head>
<body <?php body_class(); ?>>
