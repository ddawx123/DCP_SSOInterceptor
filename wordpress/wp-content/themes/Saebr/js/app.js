...
$(function() {
	...
	console.log("%c DingStudio %c","background:#24272A; color:#ffffff","","站长信息");
	console.log("%c David Ding %c","background:#24272A; color:#ffffff","","http://www.dingstudio.cn"); 
    console.log("%c Ding Cloud %c","background:#24272A; color:#ffffff","","http://passport.dingstudio.cn");
