...
function login_ok(){ 
  ...
  get_currentuserinfo();
?>
  <p class="ex-login-avatar"><a href="#" class="user-panel"><img alt="" src="<?php bloginfo('template_url'); ?>/images/avatar.jpg" srcset="<?php bloginfo('template_url'); ?>/images/avatar.jpg" class="avatar avatar-110 photo" height="110" width="110"></a></p>
...
function header_user_menu(){
  ...
  if(is_user_logged_in()){
    ...
    <!--添加自定义头像-->
     <a href="#" class="user-panel"><img alt="" src="<?php bloginfo('template_url'); ?>/images/avatar.jpg" srcset="<?php bloginfo('template_url'); ?>/images/avatar.jpg" class="avatar avatar-110 photo" height="110" width="110"></a>
     
      
      
      <div class="header-user-menu">
        <div class="herder-user-name">当前登录为 
  ...
  <div class="header-user-avatar">
    ...
    <div class="header-user-menu">
      <div class="herder-user-name no-logged">是否现在登录 ?
